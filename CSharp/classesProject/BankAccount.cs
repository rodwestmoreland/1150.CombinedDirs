...
namespace classesProject
{
	public class BankAccount
	{
		...
		private static int accountNumberSeed = 1122334400;
		...
		public BankAccount(string name, decimal initialBalance)
			{
				...
				accountNumberSeed++;
				MakeDeposit(initialBalance, DateTime.Now, "init balance");
			}
		public void MakeDeposit(decimal amount, DateTime date, string note)
			{
				if (amount <= 0)
				{
					throw new ArgumentOutOfRangeException(nameof(amount),"Not valid" );
				}
